...
<script type="text/html" id="toolBtn">
	...
	{{# if('0' == ${sessionScope.user.urole}){  }}		
    	<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">查看</a>
	{{#  } }}
    <a class="layui-btn layui-btn-xs" lay-event="updateStatus">更新</a>
...
<%-- 	if(!uId){
    ...
    function() {
        ...
        table.render({
            elem:'#postLoanData',
            url:'<%=basePath%>admin/getPostLoanList',
            page:true,
            toolbar: '#toolBtn',
        ...
        table.on('toolbar(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                parent.xadmin.add_tab('查看状态更新',"<%=basePath%>admin/toPostLoan?contractId="+ editEdCon.contractId + "&viewFlag=1",'true');
