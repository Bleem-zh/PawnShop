    ...
    layui.use(['layer', 'form','table','laydate','upload'],function() {
        ...
        table.render({
            ...
            defaultToolbar: [{title: '新增' //标题
		             ...
		             {title: '刷新' //标题
	                  ,layEvent: 'tbReflesh' //事件名，用于 toolbar 事件中使用 layui-icon-delete
            ...
            cols:[[
                ...
                {field:'productType',title:'产品类型', hide:true}
            ]],
            where:{
            	productType:"A0001"
            }
       ...
       table.on('toolbar(proTable)', function(obj){
    	   if(obj.event === 'tbReflesh'){
        	   ...
        	   parent.xadmin.add_tab('新增房产典当物','<%=basePath%>pawn/toAddProperty?productType=A0001');
           }
               ...
               layer.open({
                   ...
                   success: function (layero, index) {
						...
						for(var key in editEd) {
							...
							body.find("#"+key).val(editEd[key]);
							
						} */
            	   },end: function(){
	           			table.reload('proData',{
	        				where: {productType:"A0001"}
	        			});
         			}
               });
